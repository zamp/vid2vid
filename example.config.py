...
render_passes = [
    {"type": "comfyui", "input_dir": video_dir, "video_dir": video_dir, "output_dir": output_dir, "workflow":wf_quarter, "model":mdl, "cfg":8, "denoise": 0.3, "positive_prompt": pp, "negative_prompt": np },
    ...
    {"type": "comfyui", "input_dir": video_dir, "video_dir": video_dir, "output_dir": output_dir, "workflow":wf_half, "model":mdl, "cfg":8, "denoise": 0.2, "positive_prompt": pp, "negative_prompt": np },
    ...
    {"type": "comfyui", "input_dir": video_dir, "video_dir": video_dir, "output_dir": output_dir, "workflow":wf_full, "model":mdl, "cfg":8, "denoise": 0.1, "positive_prompt": pp, "negative_prompt": np },
    ...
    {"type": "comfyui", "input_dir": video_dir, "video_dir": video_dir, "output_dir": output_dir, "workflow":wf_full, "model":mdl, "cfg":8, "denoise": 0.05, "positive_prompt": pp, "negative_prompt": np },
]
