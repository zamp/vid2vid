...
render_passes = [
    ...
    {"type": "comfyui", "input_dir": video_dir, "video_dir": video_dir, "output_dir": output_dir, "workflow":wf, "model":mdl, "cfg":8, "denoise": 0.2, "positive_prompt": pp, "negative_prompt": np },
    ...
    {"type": "comfyui", "input_dir": video_dir, "video_dir": video_dir, "output_dir": output_dir, "workflow":wf, "model":mdl, "cfg":8, "denoise": 0.1, "positive_prompt": pp, "negative_prompt": np },
    ...
    {"type": "comfyui", "input_dir": video_dir, "video_dir": video_dir, "output_dir": output_dir, "workflow":wf, "model":mdl, "cfg":8, "denoise": 0.05, "positive_prompt": pp, "negative_prompt": np },
]
